...
import com.athos.mall.system.service.IDictDataService;
...
public class DictDataController extends BaseController {
    ...
    public AjaxResult export(DictData dictData) {
        ...
        return util.exportExcel(list, "字典数据", SysConfig.getDownloadPath());
    }
