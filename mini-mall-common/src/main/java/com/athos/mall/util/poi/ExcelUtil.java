package com.athos.mall.util.poi;


import com.athos.mall.bean.AjaxResult;
import com.athos.mall.exception.BusinessException;
import com.athos.mall.lang.anotation.Excel;
import com.athos.mall.lang.anotation.Excel.Type;
import com.athos.mall.reflect.ReflectUtils;
import com.athos.mall.tool.Convert;
import com.athos.mall.util.DateUtils;
...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public AjaxResult exportExcel(List<T> list, String sheetName, String downLoadPath) {
        this.init(list, sheetName, Excel.Type.EXPORT);
        return exportExcel(downLoadPath);
    }
     ...
     * @return 结果
     */
    public AjaxResult importTemplateExcel(String sheetName,String downLoadPath) {
     ...
     * @return 结果
     */
    public AjaxResult exportExcel(String downLoadPath) {
        ...
        try {
            ...
            out = new FileOutputStream(getAbsoluteFile(filename,downLoadPath));
            wb.write(out);
     ...
     * @param filename 文件名称
     */
    public String getAbsoluteFile(String filename,String downLoad) {
